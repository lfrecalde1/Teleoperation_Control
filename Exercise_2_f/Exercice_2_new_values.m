...
initial = 1;
% System simulation
[q_s, q_m, q_s_delay, q_m_delay, x_s, x_m_base, x_s_delay, x_m_base_delay, xp_s, xp_m, xp_s_delay, xp_m_delay, he_m, he_s, RMSE_x_s_new, RMSE_y_s_new, t, u_cartesian_s, u_cartesian_m, x_m_0, e_new] = Tele_system_simu(X, h1, h2, t, t_s, L1_s, L2_s, L1_m, L2_m, qs(:, initial), qm(:, initial));
...
save("Data_Delay_f_new.mat", "q_s", "q_m", "q_s_delay", "q_m_delay", "x_s", "x_m_base", "x_s_delay", "x_m_base_delay", "xp_s", "xp_m", "xp_s_delay", "xp_m_delay", "he_m", "he_s", "RMSE_x_s_new", "RMSE_y_s_new", "t", "u_cartesian_s", "u_cartesian_m", "x_m_0", "L1_s", "L2_s", "L1_m", "L2_m", "e_new", "signal_h1", "signal_h2");
