...
export_fig Results_delay_signals_6_5.pdf -q101
...
axes('Position',[0.05 0.6 .42 0.35]);
%% Data generation
x_m_delay_plot_a = line(t,x_m_base_delay(1,:,1));
set(x_m_delay_plot_a, 'LineStyle', '-', 'Color', C1, 'LineWidth', lw*1.2);
x_s_delay_plot_a = line(t,x_s_delay(1,:,1));
set(x_s_delay_plot_a, 'LineStyle', '--', 'Color', C2, 'LineWidth', lw);

x_m_delay_plot_b = line(t,x_m_base_delay(1,:,2));
set(x_m_delay_plot_b, 'LineStyle', '-', 'Color', C3, 'LineWidth', lw*1.2);
x_s_delay_plot_b = line(t,x_s_delay(1,:,2));
set(x_s_delay_plot_b, 'LineStyle', '--', 'Color', C4, 'LineWidth', lw);

x_m_delay_plot_c = line(t,x_m_base_delay(1,:,3));
set(x_m_delay_plot_c, 'LineStyle', '-', 'Color', C5, 'LineWidth', lw*1.2);
x_s_delay_plot_c = line(t,x_s_delay(1,:,3));
set(x_s_delay_plot_c, 'LineStyle', '--', 'Color', C6, 'LineWidth', lw);

x_m_delay_plot_d = line(t,x_m_base_delay(1,:,4));
set(x_m_delay_plot_d, 'LineStyle', '-', 'Color', C7, 'LineWidth', lw*1.2);
x_s_delay_plot_d = line(t,x_s_delay(1,:,4));
set(x_s_delay_plot_d, 'LineStyle', '--', 'Color', C8, 'LineWidth', lw);
...
%% Legend nomeclature
hLegend_3 = legend([x_s_delay_plot_a,x_m_delay_plot_a, x_s_delay_plot_b,x_m_delay_plot_b, x_s_delay_plot_c,x_m_delay_plot_c, x_s_delay_plot_d,x_m_delay_plot_d],{'$^{a}{x}_s(t-h_2)$','$^{a}{x}_m(t-h_1)$','$^{b}{x}_s(t-h_2)$','$^{b}{x}_m(t-h_1)$', '$^{c}{x}_s(t-h_2)$','$^{c}{x}_m(t-h_1)$', '$^{d}{x}_s(t-h_2)$','$^{d}{x}_m(t-h_1)$'},'fontsize',12,'interpreter','latex','Color',[255 255 255]/255,'Location','best','NumColumns',2,'TextColor','black');
 set(gca,'ticklabelinterpreter','latex',...
         'fontsize',fontsizeTicks)
...
axes('Position',[0.52 0.6 .42 0.35]);
%% Data generation
y_m_delay_plot_a = line(t,x_m_base_delay(2,:,1));
set(y_m_delay_plot_a, 'LineStyle', '-', 'Color', C9, 'LineWidth', lw*1.2);
y_s_delay_plot_a = line(t,x_s_delay(2,:,1));
set(y_s_delay_plot_a, 'LineStyle', '--', 'Color', C10, 'LineWidth', lw);

y_m_delay_plot_b = line(t,x_m_base_delay(2,:,2));
set(y_m_delay_plot_b, 'LineStyle', '-', 'Color', C11, 'LineWidth', lw*1.2);
y_s_delay_plot_b = line(t,x_s_delay(2,:,2));
set(y_s_delay_plot_b, 'LineStyle', '--', 'Color', C12, 'LineWidth', lw);

y_m_delay_plot_c = line(t,x_m_base_delay(2,:,3));
set(y_m_delay_plot_c, 'LineStyle', '-', 'Color', C13, 'LineWidth', lw*1.2);
y_s_delay_plot_c = line(t,x_s_delay(2,:,3));
set(y_s_delay_plot_c, 'LineStyle', '--', 'Color', C14, 'LineWidth', lw);

y_m_delay_plot_d = line(t,x_m_base_delay(2,:,4));
set(y_m_delay_plot_d, 'LineStyle', '-', 'Color', C15, 'LineWidth', lw*1.2);
y_s_delay_plot_d = line(t,x_s_delay(2,:,4));
set(y_s_delay_plot_d, 'LineStyle', '--', 'Color', C16, 'LineWidth', lw);
...
%% Legend nomeclature
hLegend_4 = legend([y_s_delay_plot_a,y_m_delay_plot_a,y_s_delay_plot_b,y_m_delay_plot_b,y_s_delay_plot_c,y_m_delay_plot_c,y_s_delay_plot_d,y_m_delay_plot_d],{'$^{a}{y}_s(t-h_2)$','$^{a}{y}_m(t-h_1)$','$^{b}{y}_s(t-h_2)$','$^{b}{y}_m(t-h_1)$','$^{c}{y}_s(t-h_2)$','$^{c}{y}_m(t-h_1)$','$^{d}{y}_s(t-h_2)$','$^{d}{y}_m(t-h_1)$'},'fontsize',12,'interpreter','latex','Color',[255 255 255]/255,'Location','best','NumColumns',2,'TextColor','black');
 set(gca,'ticklabelinterpreter','latex',...
         'fontsize',fontsizeTicks)
...
axes('Position',[0.05 0.2 .42 0.35]);
%% Data generation
x_m_delay_plot_e = line(t,x_m_base_delay(1,:,5));
set(x_m_delay_plot_e, 'LineStyle', '-', 'Color', C1, 'LineWidth', lw*1.2);
x_s_delay_plot_e = line(t,x_s_delay(1,:,5));
set(x_s_delay_plot_e, 'LineStyle', '--', 'Color', C2, 'LineWidth', lw);

x_m_delay_plot_f = line(t,x_m_base_delay(1,:,6));
set(x_m_delay_plot_f, 'LineStyle', '-', 'Color', C3, 'LineWidth', lw*1.2);
x_s_delay_plot_f = line(t,x_s_delay(1,:,6));
set(x_s_delay_plot_f, 'LineStyle', '--', 'Color', C4, 'LineWidth', lw);

x_m_delay_plot_g = line(t,x_m_base_delay(1,:,7));
set(x_m_delay_plot_g, 'LineStyle', '-', 'Color', C5, 'LineWidth', lw*1.2);
x_s_delay_plot_g = line(t,x_s_delay(1,:,7));
set(x_s_delay_plot_g, 'LineStyle', '--', 'Color', C6, 'LineWidth', lw);

x_m_delay_plot_h = line(t,x_m_base_delay(1,:,8));
set(x_m_delay_plot_h, 'LineStyle', '-', 'Color', C7, 'LineWidth', lw*1.2);
x_s_delay_plot_h = line(t,x_s_delay(1,:,8));
set(x_s_delay_plot_h, 'LineStyle', '--', 'Color', C8, 'LineWidth', lw);
...
%% Legend nomeclature
hLegend_3 = legend([x_s_delay_plot_e,x_m_delay_plot_e, x_s_delay_plot_f,x_m_delay_plot_f, x_s_delay_plot_g,x_m_delay_plot_g, x_s_delay_plot_h,x_m_delay_plot_h],{'$^{e}{x}_s(t-h_2)$','$^{e}{x}_m(t-h_1)$','$^{f}{x}_s(t-h_2)$','$^{f}{x}_m(t-h_1)$', '$^{g}{x}_s(t-h_2)$','$^{g}{x}_m(t-h_1)$', '$^{h}{x}_s(t-h_2)$','$^{h}{x}_m(t-h_1)$'},'fontsize',12,'interpreter','latex','Color',[255 255 255]/255,'Location','best','NumColumns',2,'TextColor','black');
 set(gca,'ticklabelinterpreter','latex',...
         'fontsize',fontsizeTicks)
...
axes('Position',[0.52 0.2 .42 0.35]);
%% Data generation
y_m_delay_plot_e = line(t,x_m_base_delay(2,:,5));
set(y_m_delay_plot_e, 'LineStyle', '-', 'Color', C9, 'LineWidth', lw*1.2);
y_s_delay_plot_e = line(t,x_s_delay(2,:,5));
set(y_s_delay_plot_e, 'LineStyle', '--', 'Color', C10, 'LineWidth', lw);

y_m_delay_plot_f = line(t,x_m_base_delay(2,:,6));
set(y_m_delay_plot_f, 'LineStyle', '-', 'Color', C11, 'LineWidth', lw*1.2);
y_s_delay_plot_f = line(t,x_s_delay(2,:,6));
set(y_s_delay_plot_f, 'LineStyle', '--', 'Color', C12, 'LineWidth', lw);

y_m_delay_plot_g = line(t,x_m_base_delay(2,:,7));
set(y_m_delay_plot_g, 'LineStyle', '-', 'Color', C13, 'LineWidth', lw*1.2);
y_s_delay_plot_g = line(t,x_s_delay(2,:,7));
set(y_s_delay_plot_g, 'LineStyle', '--', 'Color', C14, 'LineWidth', lw);

y_m_delay_plot_h = line(t,x_m_base_delay(2,:,8));
set(y_m_delay_plot_h, 'LineStyle', '-', 'Color', C15, 'LineWidth', lw*1.2);
y_s_delay_plot_h = line(t,x_s_delay(2,:,8));
set(y_s_delay_plot_h, 'LineStyle', '--', 'Color', C16, 'LineWidth', lw);
...
%% Legend nomeclature
hLegend_4 = legend([y_s_delay_plot_e,y_m_delay_plot_e,y_s_delay_plot_f,y_m_delay_plot_f,y_s_delay_plot_g,y_m_delay_plot_g,y_s_delay_plot_h,y_m_delay_plot_h],{'$^{e}{y}_s(t-h_2)$','$^{e}{y}_m(t-h_1)$','$^{f}{y}_s(t-h_2)$','$^{f}{y}_m(t-h_1)$','$^{g}{y}_s(t-h_2)$','$^{g}{y}_m(t-h_1)$','$^{h}{y}_s(t-h_2)$','$^{h}{y}_m(t-h_1)$'},'fontsize',12,'interpreter','latex','Color',[255 255 255]/255,'Location','best','NumColumns',2,'TextColor','black');
 set(gca,'ticklabelinterpreter','latex',...
         'fontsize',fontsizeTicks)
...
set(gcf, 'Color', 'w'); % Sets axes background
export_fig Results_delay_signals_positions_6_5.pdf -q101
...
set(gcf, 'Color', 'w'); % Sets axes background
export_fig Results_delay_Forces_6_5.pdf -q101
...
set(gcf, 'Color', 'w'); % Sets axes background
export_fig Results_delay_Error_Forces_6_5.pdf -q101
...
set(gcf, 'Color', 'w'); % Sets axes background
export_fig Comparative_results_6_5.pdf -q101
