...
export_fig Results_delay_signals_3.pdf -q101
...
set(gcf, 'Color', 'w'); % Sets axes background
export_fig Results_delay_Torques_3.pdf -q101
...
link_1_plot_t_0 = plot(xd_i(1, 1), xd_i(2, 1),'x','Color', C12, 'LineWidth', lw*1.5);
hold on;
...
set(wall_t_0, 'LineStyle', '-', 'Color', [ 0 0 0], 'LineWidth', lw*1.5);
...
%% Legend nomeclature
hLegend_7 = legend([l_1_s_real_t_0, l_1_m_real_t_0, link_1_plot_t_0],{'$\textrm{Slave}$','$\textrm{Master}$', '$\textrm{Desired}$'},'fontsize',10,'interpreter','latex','Color',[255 255 255]/255,'Location','best','NumColumns',1,'TextColor','black');
set(gca,'ticklabelinterpreter','latex',...
        'fontsize',fontsizeTicks)
% Figure properties
ax_7 = gca;
...
% %% Desired  system plot
link_1_plot_t_30 = plot(xd_i(1, end), xd_i(2, end),'x','Color', C12, 'LineWidth', lw*1.5);
hold on;
% rectangle('Position',[0-m1r/2 0-m1r/2 m1r m1r],'Curvature',1,'FaceColor',c1);
...
set(wall_t_30, 'LineStyle', '-', 'Color', [0 0 0], 'LineWidth', lw*1.5);
...
%% Legend nomeclature
hLegend_8 = legend([l_1_s_real_t_f, l_1_m_real_t_f, link_1_plot_t_30],{'$\textrm{Slave}$','$\textrm{Master}$', '$\textrm{Desired}$'},'fontsize',10,'interpreter','latex','Color',[255 255 255]/255,'Location','best','NumColumns',1,'TextColor','black');
set(gca,'ticklabelinterpreter','latex',...
        'fontsize',fontsizeTicks)
% Figure properties
ax_8 = gca;
...
ax_8.YLim = [-1.8 1.8];
set(gcf, 'Color', 'w'); % Sets axes background
export_fig Results_Delay_Links_3.pdf -q101
...
%% Legend nomeclature
hLegend_5 = legend([Fh_1_plot,Fh_2_plot],{'$F_{hx}$','$F_{hy}$'},'fontsize',12,'interpreter','latex','Color',[255 255 255]/255,'Location','best','NumColumns',1,'TextColor','black');
 set(gca,'ticklabelinterpreter','latex',...
         'fontsize',fontsizeTicks)
...
%% Legend nomeclature
hLegend_6 = legend([F_e_1_plot,F_e_2_plot],{'$F_{ex}$','$F_{ey}$'},'fontsize',12,'interpreter','latex','Color',[255 255 255]/255,'Location','best','NumColumns',1,'TextColor','black');
 set(gca,'ticklabelinterpreter','latex',...
         'fontsize',fontsizeTicks)
...
axes('Position',[0.05 0.6 .42 0.35]);
%% Data generation
Fhe_1_plot = line(t,F_h_real(1,:)-F_enviroment_real(1,1:length(t)));
...
Fhe_2_plot  = line(t,F_h_real(2,:)-F_enviroment_real(2,1:length(t)));
...
%% Legend nomeclature
hLegend_10 = legend([e_real_plot],{'$||\tilde{\mathbf{x}}||_{Initial}$'},'fontsize',12,'interpreter','latex','Color',[255 255 255]/255,'Location','best','NumColumns',1,'TextColor','black');
 set(gca,'ticklabelinterpreter','latex',...
         'fontsize',fontsizeTicks)
...
ERROR = [RMSE_x_s_real; RMSE_y_s_real];
bar(ERROR);
