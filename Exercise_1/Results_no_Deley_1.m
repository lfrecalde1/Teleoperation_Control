...
export_fig Results_No delay_signals_1.pdf -q101
...
set(gcf, 'Color', 'w'); % Sets axes background
export_fig Results_No delay_Torques_1.pdf -q101
...
ax_8.YLim = [-1.8 1.8];
set(gcf, 'Color', 'w'); % Sets axes background
export_fig Results_No_Delay_Links_1.pdf -q101
...
%legend({'$RMSE_x$','$RMSE_y$'},'fontsize',10,'interpreter','latex','Color',[255 255 255]/255,'TextColor','black')
...
ax_9.LineWidth = 0.8;
set(gcf, 'Color', 'w'); % Sets axes background
export_fig Comparative_results_1.pdf -q101
