...
export_fig Results_No delay_signals_2.pdf -q101
...
set(gcf, 'Color', 'w'); % Sets axes background
export_fig Results_No delay_Torques_2.pdf -q101
...
ax_8.YLim = [-1.8 1.8];
set(gcf, 'Color', 'w'); % Sets axes background
export_fig Results_No_Delay_Links_2.pdf -q101
...
ax_9.LineWidth = 0.8;
set(gcf, 'Color', 'w'); % Sets axes background
export_fig Comparative_results_2.pdf -q101
