...
export_fig Results_delay_signals_h.pdf -q101
...
set(gcf, 'Color', 'w'); % Sets axes background
export_fig Results_delay_Torques_h.pdf -q101
...
ax_8.YLim = [-1.8 1.8];
set(gcf, 'Color', 'w'); % Sets axes background
export_fig Results_Delay_Links_h.pdf -q101


%% Load Old Data
load("Data_Delay_h_real.mat");
figure('Position', [500 500 sizeX sizeY])
set(gcf, 'Position', [500 500 sizeX sizeY]);
fig1_comps.fig = gcf;
...
set(gcf, 'Color', 'w'); % Sets axes background
export_fig Comparative_results_h.pdf -q101
